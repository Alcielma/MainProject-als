...
import { NewAppointmentTypeComponent } from './new-appointment-type/new-appointment-type.component';
...
const routes: Routes = [
  ...
  { path: 'new-appointment-type', component: NewAppointmentTypeComponent, canActivate: [authGuard] },
